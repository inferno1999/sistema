...
$ide = $_POST['ide'];
$sql_edit= "SELECT idcliente, grado, nombre, ape_paterno, ape_materno, edad, direccion, dni, operatividad, felcc, felcn from cliente where idcliente =$ide;";
      ...
      <div class='modal-body'>
        ...
        <form class='form-horizontal well' data-async data-target='#rating-modal'>
            <div class='col-lg-10'>
                ...
                <div class='form-group'>
                    <label for='dir_edit' class='col-lg-2 control-label'>Direcci�n</label>
                    <div class='col-lg-10'>
